  ...
  for (const el of slideData.elements) {
    if (el.type === 'image') {
      ...
      const listOptions = {
        ...
        fit: 'shrink'  // Shrink text to fit box
      };
      ...
      // Make text wider to account for underestimate
      // Single-line: 5% wider, multi-line: 2% wider
      const widthIncrease = isSingleLine ? el.position.w * 0.03 : el.position.w * 0.02;
      ...
      // Add shrink fit for all text to prevent overflow
